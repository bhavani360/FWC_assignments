...
\title{\mytitle}
\author{\myauthor\hspace{1em}\\\contact\\FWC22017\hspace{6.5em}IITH\hspace{0.5em}
\mymodule\hspace{6em}ASSIGNMENT}
\begin{document}
	\maketitle
	\tableofcontents
\section*{problem}
...
\section*{solution}
Implementing the given function using NANAD Gates only
\begin{center}
 $\boldmath{F = XY + YZ}$
\end{center}
\begin{figure}[h]
...
\begin{center}
\fbox{\parbox{8cm}{\url{https://github.com/bhavani360/FWC_assignments/blob/main/iot/codes/setup/src/main.cpp}}}
\end{center}
\begin{center}
\end{center}
\begin{lstlisting}
svn co https://github.com/bhavani360/FWC_assignments/trunk/iot/codes/setup
cd  setup
pio run
pio run -t upload
\end{lstlisting}
...
cd codes
\end{lstlisting}
\item Assuming that the username is OnePlus 7Pro and password is bhavani@360, flash the following code wirelessly
\begin{center}
\fbox{\parbox{8cm}{\url{https://github.com/bhavani360/FWC_assignments/blob/main/iot/codes/src/main.cpp}}}
\end{center}
through 
\begin{lstlisting}
pio run 
